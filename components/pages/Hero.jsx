...
export default function Hero() {
  ...
  return (
    <header className="relative max-w-6xl mx-auto px-5 sm:px-8 pt-8 sm:pt-20 pb-20 sm:pb-28">
      ...
      <div className="mobile-photo-carousel sm:hidden">
        <div className="mobile-photo-carousel-track">

          {images.map((image, index) => {
            /*
             * Calculate where each image currently belongs.
             *
             * 0 = center
             * 1 = first card behind
             * 2 = second card behind
             */
            ...
            return (
              <div
                key={image.src}
                className={`mobile-photo-item mobile-photo-position-${position}`}
              >
        ...
        <div className="stamp absolute bottom-6 right-8 w-16 h-16 flex items-center justify-center text-center text-[10px] font-semibold z-20 bg-[var(--paper)]">
      ...
      <div className="grid md:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
            ...
            <h1 className="display text-[2.6rem] leading-[1.05] sm:text-6xl sm:leading-[1.03] font-semibold mt-1">
              ...
              {PROFILE.heroHeadline.map((line, i) => (
                <span key={i}>
                  ...
                  {i < PROFILE.heroHeadline.length - 1 && (
                    <br />
                  )}
                </span>
              ))}
        ...
        {/* ===================================================
            ...
            This is your previous desktop animation.
      ...
      <div className="mt-20 md:mt-40 grid md:grid-cols-2 gap-12 items-center">
